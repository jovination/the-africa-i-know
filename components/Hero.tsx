...
export default function Hero(){
    return(
        <div className="container mx-auto px-6 md:px-8 w-full">
            ...
            <div className="w-full md:w-fit grid grid-cols-1 md:grid-cols-2 gap-3 px-20">
                <Button className="w-full bg-[#9F8033] h-12 hover:bg-[#9f8033]/90 px-2 md:px-6">Listen the Great Africans     <Mic className="ml-2" /></Button>
                <Button variant="outline" className="w-full h-12 text-black border-2 border-black/70 px-2 md:px-6"> Follow the Movement <ArrowRight className="ml-2" /></Button>
            </div>
