...
export default function Hero(){
    return(
        <div className="container mx-auto px-6 md:px-8 w-full">
            ...
            <h1 className="text-black text-5xl md:text-6xl font-bold text-center">THE AFRICA I KNOW</h1>
            ...
            <div className="w-full md:w-fit grid grid-cols-1 md:grid-cols-2 gap-3">
                <Button className="w-full bg-[#9F8033] h-11 hover:bg-[#9f8033]/90 px-6">Listen the Great Africans     <Mic className="ml-2" /></Button>
                <Button variant="outline" className="w-full h-11 text-black border-2 border-black/70 px-6"> Follow the Movement <ArrowRight className="ml-2" /></Button>
            </div>
