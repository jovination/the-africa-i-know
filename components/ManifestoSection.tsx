...
export default function ManifestoSection() {
    return (
        <div className="w-full min-h-screen bg-[#FEF7ED] ">
            <div className="w-full container mx-auto px-4 md:px-6 flex flex-col items-center py-10 space-y-4">
            ...
            <div className="max-w-6xl w-full bg-[#F8F0E4] rounded-2xl  mt-10 p-10 flex flex-row gap-10 ">
                <div className="max-w-[300px] w-full h-[300px] relative overflow-hidden rounded-2xl">
