...
export default function TheGreatAfricans() {
    return (
        <div className=" w-full container mx-auto py-12 flex flex-col items-center">
            <div className="max-w-4xl w-full h-125 bg-[#F5F5F5] rounded-3xl overflow-hidden relative">
                <Image src="/founder.webp" alt="The Great Africans" fill className="w-full h-full object-cover" />
            </div>
